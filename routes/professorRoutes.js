...
const professorController = require('../controllers/professorController'); // Importe o controlador correto

// Rota para adicionar disciplinas e campus a um professor (POST)
router.post('/form_adicionar_disciplinas_campus', professorController.adicionarDisciplinasECampus);
